...
function Swiping({ db }) {
    ...
    const handleMakeList = async () => {
        ...
        const selectedPlaces = db.filter((place) =>
            placeId.includes(place.placeId)
        );

        try {
            const title = await axios
                .post("/api/get-title", {
                    data: JSON.stringify(selectedPlaces),
                })
                .then((res) => res.data);
            const description = await axios
                .post("/api/get-description", {
                    data: JSON.stringify(selectedPlaces),
                })
                .then((res) => res.data);
